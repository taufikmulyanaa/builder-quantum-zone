...
export default function Index() {
  const tasks = useMemo(
    () => [
      {
        id: 1,
        title: "1. Biodata Lengkap & Mengikuti Akademi Dasar",
        percent: 80,
      },
        ...
        <div className="grid grid-cols-12 gap-8">
          <div className="col-span-5 xl:col-span-4">
            ...
            <p className="mb-6 text-sm text-muted-foreground">
              Langkah-langkah untuk memulai perjalanan karir Anda bersama
              Akademi Indonesia.
            </p>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="mt-1 text-xs text-muted-foreground">
                          Selesaikan semua langkah dengan benar dan jelas
                        </div>
                      </div>
                    </div>
                    <span className="rounded-full bg-amber-100 px-2.5 py-1 text-xs font-semibold text-orange-700">
                      {t.percent}%
                    </span>
                  </div>
                  <div className="mt-3 h-2 w-full overflow-hidden rounded-full bg-muted">
                    <div
                      className="h-full rounded-full bg-gradient-to-r from-amber-300 via-orange-400 to-orange-600"
          ...
          <div className="col-span-7 xl:col-span-8">
            ...
            <div className="grid grid-cols-12 gap-6">
              ...
              <div
                className="relative col-span-12 overflow-hidden rounded-3xl p-6 text-white shadow-lg md:col-span-7"
                style={{
                  background:
                ...
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">
                        Akan berakhir dalam 12 hari lagi
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-span-12 mt-2">
                <div className="mb-4 flex items-center justify-between">
                  ...
                  <Button
                    asChild
                    variant="ghost"
                    className="text-orange-700 hover:bg-amber-100"
                  >
                  ...
                  {[1, 2, 3].map((i) => (
                    ...
                    >
                      ...
                      <div className="space-y-2 p-4">
                        ...
                        <div className="font-semibold">
                          Dasar-Dasar Pengetahuan Umum {i}
                        </div>
                        <div className="flex items-center justify-between text-xs text-muted-foreground">
                          ...
                          <span className="inline-flex items-center gap-1">
                            <FileText className="size-3" /> Sertifikat
                          </span>
                        </div>
                      </div>
                    </div>
